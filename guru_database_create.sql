...
create table unit_of_meashure (id bigint not null auto_increment, description varchar(255), primary key (id)) engine=InnoDB
alter table ingredient add constraint FKj0s4ywmqqqw4h5iommigh5yja foreign key (recipe_id) references recipe (id)
alter table ingredient add constraint FK1ui3inrrs2hsfibi5xoh6ce6o foreign key (uom_id) references unit_of_meashure (id)
